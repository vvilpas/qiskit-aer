...
namespace{
  using Cvode_Wrapper_t = AER::CvodeWrapper<py::array_t<complex_t>>; //AER::CvodeWrapper<std::vector<complex_t>>;
...
//      .def_property("_y", [](const Cvode_Wrapper_t &cvode){return py::array(cvode.get_solution());},
//          &Cvode_Wrapper_t::set_solution)
      .def_property("_y", [](const Cvode_Wrapper_t &cvode){return cvode.get_solution();},
          &Cvode_Wrapper_t::set_solution)
//      .def_property_readonly("y", [](const Cvode_Wrapper_t &cvode){return py::array(cvode.get_solution());})
