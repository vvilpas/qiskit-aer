...
namespace AER{
  ...
  template<>
  CvodeWrapper<std::vector<complex_t>>::CvodeWrapper(){
    y_ = SundialsComplexContent<std::vector<complex_t>>::new_vector(y);
    init(OdeMethod::ADAMS, rhs_in<std::vector<complex_t>>, 0.0, 1e-12, 1e-12);
  }
