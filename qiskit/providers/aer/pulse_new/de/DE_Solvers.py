...
class BMDE_Solver:
    ...
    def set_y(self, y: np.ndarray, y_in_frame: Optional[bool] = False):
        ...
        if y_in_frame:
            ...
            # frame basis
            new_y = self._generator._frame.state_into_frame_basis(new_y)
        else:
            # if y not in frame, convert it into frame and into frame basis
            new_y = self._generator._frame.state_into_frame(self.t,
                                                            new_y,
    ...
    def get_y(self, return_in_frame: Optional[bool] = False):
        ...
        if return_in_frame:
            ...
            # of the frame basis
            return_y = self._generator._frame.state_out_of_frame_basis(return_y)
        else:
            ...
            # basis
            return_y = self._generator._frame.state_out_of_frame(self.t,
                                                          return_y,
